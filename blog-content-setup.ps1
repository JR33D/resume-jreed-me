# ─────────────────────────────────────────────────────────────────────────────
# blog-content-setup.ps1
#
# Run this once to scaffold a blog-content repo that feeds jreed.me.
#
# Usage (from any directory):
#   .\blog-content-setup.ps1              # creates .\blog-content\
#   .\blog-content-setup.ps1 my-dir      # creates .\my-dir\
#
# After running:
#   1. cd into the new directory
#   2. git remote add origin <your-github-url>
#   3. git push -u origin main
#   4. Set BLOG_CONTENT_URL in your resume app's env:
#      BLOG_CONTENT_URL=https://raw.githubusercontent.com/JR33D/blog-content/main
# ─────────────────────────────────────────────────────────────────────────────

param(
    [string]$Dir = "blog-content"
)

$ErrorActionPreference = "Stop"

if (Test-Path $Dir) {
    Write-Error "Directory '$Dir' already exists. Aborting."
    exit 1
}
...
'@ | Out-File -Encoding utf8 -FilePath "index.json"
...
'@ | Out-File -Encoding utf8 -FilePath "on-being-the-second-engineer.mdx"
...
'@ | Out-File -Encoding utf8 -FilePath "event-driven-without-the-event-framework.mdx"
...
'@ | Out-File -Encoding utf8 -FilePath "reading-architecture-diagrams.mdx"
...
'@ | Out-File -Encoding utf8 -FilePath "the-quiet-power-of-a-boring-stack.mdx"
...
'@ | Out-File -Encoding utf8 -FilePath "mentorship-is-a-design-problem.mdx"
...
Write-Host ""
Write-Host "blog-content repo created in .\$Dir" -ForegroundColor Green
Write-Host ""
...
Write-Host ""
Write-Host "Then set in your resume app's environment:"
Write-Host "  BLOG_CONTENT_URL=https://raw.githubusercontent.com/JR33D/<repo>/main"
